...
(function($){
			...
			if ($('#'+id).length == 0) {
				...
				table.append(
					...
					$(options.rowTpl)
						...
						//})))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(".").addClass('numero')))
	...
	*/
	...
	$.fn.numpad.defaults = {
		...
		textDone: '<img src="checkmark-black.png" height = 20px>',
		textDelete: '<img src="backspace-x-arrow-black-large.png" height = 18px>',
		textClear: '<img src="backspace-x-box-arrow-black-large.png" height = 18px>',
		textCancel: '<img src="back-arrow-black.png" height = 20px>',
		decimalSeparator: ',',
		precision: null,
